function moduleProject3() {
  ...
  function buildFooter(footerData) {
    ...
    let companyInforDiv = document.createElement('div')
    companyInforDiv.classList.add('company-info')
    ...
    contactEmailP.classList.add('contact-name')
    contactEmailP.innerHTML = `Email: <a href="mailto:${footerData.contactEmail}"> ${footerData.contactEmail}</a>`

    companyInforDiv.appendChild(companyNameP)
    companyInforDiv.appendChild(addressP)
    companyInforDiv.appendChild(contactEmailP)
    ...
    footer.appendChild(companyInforDiv)
